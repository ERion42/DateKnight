       ...
       <>
            <div className="px-4 pt-5 my-5 text-center border-bottom">
                    ...
                    <div className="col-lg-6 mx-auto">
                        <p className="lead mb-4">I was part of something special. Did he just throw my cat out of the window? Life finds a way. Hey, take a look at the earthlings. Goodbye! Must go faster. Yeah, but John, if The Pirates of the Caribbean breaks down, the pirates don’t eat the tourists.</p>
                    </div>  
                    <img src={AboutPic} className="img-fluid border rounded-3 shadow-lg mb-4 align-content-center" alt="Example" loading="lazy"></img>
            </div>        

            <h2 className="text-center">Icon grid</h2>
            ...
            <div className="container px-4" id="icon-grid">
                ...
                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 py-5">
                    <div className="col d-flex align-items-start">
                        ...
                        <div>
                        <h3 className="fw-bold ps-2">Featured title</h3>
                            <p className="ms-1">God help us, we're in the hands of engineers.</p>
                        </div>
                    </div>
                    <div className="col d-flex align-items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36px" height="36px"  fill="currentColor" className="bi bi-alarm" viewBox="0 0 16 16">
                        ...
                        <div>
                        <h3 className="fw-bold ps-2">Featured title</h3>
                            <p className="ms-1">Hey, take a look at the earthlings. Goodbye!</p>
                        </div>
                    </div>
                    <div className="col d-flex align-items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36px" height="36px"  fill="currentColor" className="bi bi-alarm" viewBox="0 0 16 16">
                        ...
                        <div>
                        <h3 className="fw-bold ps-2">Featured title</h3>
                            <p className="ms-1">Yeah, but John, if The Pirates of the Caribbean.</p>
                        </div>
                    </div>
                    <div className="col d-flex align-items-start">
                        <svg xmlns="http://www.w3.org/2000/svg" width="36px" height="36px"  fill="currentColor" className="bi bi-alarm" viewBox="0 0 16 16">
